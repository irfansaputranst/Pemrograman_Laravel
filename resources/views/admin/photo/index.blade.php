...
@section('Content')
    <section style="margin-top: 80px">
        <div class="container col-xxl-8 py-5">
            ...
            <a href="" class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#uploadModal">Upload Photo</a>
                    ...
                    <tbody>
                        ...
                        @foreach ($photos as $item)
                            <tr>
                                ...
                                <td>
                                    <img src="{{ asset('storage/photo/' . $item->image) }}"
                                        class="overflow-hidden position-relative" style="height: 150px">
                                </td>
                                <td>
                                    {{ $item->judul }}
                                </td>
                            ...
                            <div class="modal fade" id="editModal{{ $item->id }}" data-bs-backdrop="static"
                                data-bs-keyboard="false" tabindex="-1" aria-labelledby="editModal" aria-hidden="true">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ route('photo.update', $item->id) }}" method="POST"
                                                ...
                                                <div class="form-group mb-3">
                                                    <label for="">Nama Kegiatan Foto</label>
